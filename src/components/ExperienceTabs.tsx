      ...
      >
        ...
        {activeTab === "second" && (
            <div>
                <div style={{ display: "flex", gap: "8px", marginBottom: "4px" }}>
                <h1 className="title-experience" style={{ margin: 0 }}>Engineer</h1>
                <h1 className="company-experience" style={{ margin: 0, color: "#B517F5" }}>@ Oracle</h1>
                </div>
                <p style={{ marginTop: 0, marginBottom: "12px" }}>
                ...
                <li className="bullet-experience" style={{ marginBottom: "10px", fontFamily: "'Poppins', sans-serif"}}>Implemented a global support contact page, reducing search time by 10–15 minutes and improving weekend availability.</li>
                </ul>
            </div>
        )}
        ...
        {activeTab === "third" && (
            <div>
                <div style={{ display: "flex", gap: "8px", marginBottom: "4px" }}>
                <h1 className="title-experience" style={{ margin: 0 }}>Engineer</h1>
                <h1 className="company-experience" style={{ margin: 0, color: "#B517F5" }}>@ Grupo Luthe</h1>
                </div>
                <p style={{ marginTop: 0, marginBottom: "12px" }}>
                ...
                <li className="bullet-experience" style={{ marginBottom: "10px", fontFamily: "'Poppins', sans-serif"}}>Assisted in migrating applications to a new Oracle APEX version, ensuring smooth transition and minimal downtime.s</li>
                </ul>
            </div>
        )}
      </div>
